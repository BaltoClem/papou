...
const Footer = () => {
    ...
    const footerStyle = {
        backgroundColor: "#fdb0aa", // Définit la couleur de fond
                ...
                <div className="row">
                    ...
                    <div className="col l6 s12">
                        ...
                        <div className='social_icons'>
                            <a href="https://www.facebook.com/yourpage"><FaFacebook size={50} color="white" /></a>
                            <a href="https://www.instagram.com/yourpage"><FaInstagram size={50} color="white" /></a>
                            <a href="https://www.linkedin.com/in/yourprofile"><FaLinkedin size={50} color="white" /></a>
                        </div>
                    </div>
                </div>
            </div>
